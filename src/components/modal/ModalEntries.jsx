    ...
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block bg-white border-2 dark:border-none dark:bg-black rounded-lg text-left shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
          <div className="absolute -inset-0.5 ring-offset-1 bg-gradient-to-r from-orengelap to-ijokepong rounded-lg blur opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"></div>
          <div className="relative rounded-lg bg-putihtrd dark:bg-abutua">
            <form onSubmit={addMoreData}>
              ...
              <div className="flex flex-col md:flex-row lg:flex-row justify-center px-4 py-5 sm:px-6 sm:flex sm:flex-row-reverse">
                <button
                  type="button"
                  className="w-full inline-flex justify-center rounded-xl border border-transparent shadow-sm px-10 py-3 bg-gradient-to-r from-orengelap to-ijokepong text-base font-medium text-white hover:bg-kuning focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:ml-3 sm:w-auto sm:text-sm"
                  onClick={addData}
                >
                  Done
                </button>
