...
const EmptyList = ({ page }) => {
  return (
    <div className="me-6 mt-6 items-center justify-center flex flex-col bg-zinc-900 border border-secondary rounded-lg h-56">
      ...
      <div className="text-white items-center justify-center mt-3">
        <span className="p-2 text-white">No {page}</span>
      </div>
    </div>
  );
};
